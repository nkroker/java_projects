...
public class FlashWindo extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        jProgressBar1.setFont(new java.awt.Font("Pristina", 0, 12)); // NOI18N
        ...
        jLabel1.getAccessibleContext().setAccessibleParent(jProgressBar1);
    ...
    public void run() {
        try
        {
            Player play = Manager.createRealizedPlayer(new File("C:\\Users\\Nikhil\\Desktop\\Project Section\\TipsNTricks2\\src\\Joy.wav").toURI().toURL());
            play.start();
