...
public class NewJFrame extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new java.awt.Color(241, 96, 0));
        jLabel1.setText("Blink");
    ...
    public void run() {
        ...
        try
        {
            Player nikhil = Manager.createRealizedPlayer(new File("C:\\Users\\Nikhil\\Desktop\\Project Section\\Fokat\\src\\converted.wav").toURI().toURL());
            nikhil.start();
