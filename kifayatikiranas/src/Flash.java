...
public class Flash extends javax.swing.JFrame implements Runnable{
    ...
    private void initComponents() {
        ...
        jProgressBar1.setBackground(new java.awt.Color(69, 255, 121));
        jProgressBar1.setForeground(new Color.green);
        jPanel1.add(jProgressBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 510, 510, -1));
    ...
    public void run() {
        ...
        try
        {
            Player play = Manager.createRealizedPlayer(new File("C:\\Users\\Nikhil\\Desktop\\Project Section\\kifayatikiranas\\src\\ProjectAudio\\Remains_Of_The_Day_10.wav").toURI().toURL());
            play.start();
            for(int i=0;i<=100;i++)
            {
